...
export const PORTFOLIO = {
  en: [
    ...
    },
    {
      ...
      presentationUrl: "/public/docs/data_warehouse_final.pdf",
      screenshots: [
      ...
      details: {
        ...
        documents: [
            { label: "Protocol Presentation", url: "/public/docs/data_warehouse_protocolo.pdf" },
            { label: "First Partial Presentation", url: "/public/docs/data_warehouse_parcial1.pdf" },
            { label: "Second Partial Presentation", url: "/public/docs/data_warehouse_parcial2.pdf" },
            { label: "Final Presentation", url: "/public/docs/data_warehouse_final.pdf" }
        ]
      }
    },
    {
    ...
    },
    {
      ...
      presentationUrl: "/public/docs/ios_store_presentation.pdf",
      screenshots: [
    ...
    },
    {
      ...
      presentationUrl: "/public/docs/appointment_app_presentation.pdf",
      screenshots: [
        "https://images.unsplash.com/photo-1555774698-0b77e0d5fac6?q=80&w=1470&auto=format&fit=crop",
  ...
  es: [
    ...
    },
    {
      ...
      details: {
        ...
        documents: [
            { label: "Presentación Protocolo", url: "/public/docs/data_warehouse_protocolo.pdf" },
            { label: "Presentación Primer Parcial", url: "/public/docs/data_warehouse_parcial1.pdf" },
            { label: "Presentación Segundo Parcial", url: "/public/docs/data_warehouse_parcial2.pdf" },
            { label: "Presentación Final", url: "/public/docs/data_warehouse_final.pdf" }
        ]
      }
    },
    {
